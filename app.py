...
app.config['MAIL_USERNAME'] = 'maherabopi7@gmail.com'
app.config['MAIL_PASSWORD'] = 'bsop jmwp lkwb bott'
app.config['MAIL_DEFAULT_SENDER'] = ('IntelliNews Team', 'maherabopi7@gmail.com')
